...
@implementation BabyRegExpHelper

#pragma mark - ***** 是否为电话号码【简单写法】
+ (BOOL)regularIsPhoneNumber:(NSString *)phoneNum
{
...
+ (BOOL)regularIsMobileNumber:(NSString *)mobileNum
{
...
+ (BOOL)regularIsChinaMobile:(NSString *)phoneNum
{
    /*!
     * 中国移动：China Mobile
...
+ (BOOL)regularIsChinaUnicom:(NSString *)phoneNum
{
    /*!
     * 中国联通：China Unicom
...
+ (BOOL)regularIsChinaTelecom:(NSString *)phoneNum
{
    /*!
     * 中国电信：China Telecom
...
{
    return [BabyRegExpHelper regularIsChinaMobile:phoneNum]? @"中国移动": ([BabyRegExpHelper regularIsChinaUnicom:phoneNum]? @"中国联通":([BabyRegExpHelper regularIsChinaTelecom:phoneNum]? @"中国电信": @"未知号码"));
}

#pragma mark - ***** 检测是否为邮箱
+ (BOOL)regularIsEmailQualified:(NSString *)emailStr
{
...
+ (BOOL)regularIsPasswordQualified:(NSString *)passwordStr
{
...
+ (BOOL)regularIsIdCardNumberQualified:(NSString *)idCardNumberStr
{    
...
+ (BOOL)regularIsIPAddress:(NSString *)iPAddressStr
{
...
+ (BOOL)regularIsAllNumber:(NSString *)allNumberStr
{
...
+ (BOOL)regularIsEnglishAlphabet:(NSString *)englishAlphabetStr
{
...
+ (BOOL)regularIsUrl:(NSString *)urlStr
{
...
+ (BOOL)regularIsChinese:(NSString *)chineseStr
{
...
+ (BOOL)regularIsNormalText:(NSString *)normalStr highLightText:(NSString *)highLightStr
{
...
+ (BOOL)regularIsUserNameInGeneral:(NSString *)userNameStr
{
...
#pragma mark - ***** 车牌号验证
+ (BOOL)regularIsValidateCarNumber:(NSString *)carNumber
{
...
#pragma mark - ***** 车型验证
+ (BOOL)regularIsValidateCarType:(NSString *)CarType
{
...
#pragma mark - ***** 昵称验证
+ (BOOL)regularIsValidateNickname:(NSString *)nickname
{
...
#pragma mark - ***** 邮政编码验证
+ (BOOL)regularIsValidPostalcode:(NSString *)postalcode
{
...
#pragma mark - ***** 工商税号验证
+ (BOOL)regularIsValidTaxNo:(NSString *)taxNo
{
...
+ (BOOL)regularIsMacAddress:(NSString *)macAddress
{
...
+ (BOOL)regularIsBankCardlNumCheck:(NSString *)bankCardlNum
{
...
+ (BOOL)regularIsLetterOrNumberString:(NSString *)string
{

...
/**
 --------------------------------------------------------------
 `BBShowManager`基于`MBProgressHUD`封装的提示管理类,MBManager
 --------------------------------------------------------------
 */
@interface BBShowManager : NSObject
...
/**
 *  显示“加载中”，带圈圈，若要修改直接修改BBLoadingMessage的值即可
 */
+ (void)showLoading;
/**
...
/**
 *  显示简短的提示语，默认2秒钟，时间可直接修改BBshowTime
 *
 *  @param alert 提示信息
 */

...
{
    return [BBRegExpHelper regularIsChinaMobile:phoneNum]? @"中国移动": ([BBRegExpHelper regularIsChinaUnicom:phoneNum]? @"中国联通":([BBRegExpHelper regularIsChinaTelecom:phoneNum]? @"中国电信": @"未知号码"));
}

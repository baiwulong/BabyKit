...
static BabyDatabaseHelper *shareDatabaseManager = nil;
@implementation BabyDatabaseHelper

#pragma mark - 数据库管理类-单例

/// 数据库管理类-单例
+(BabyDatabaseHelper *)sharedInstance{
    if (!shareDatabaseManager) {
        shareDatabaseManager = [[BabyDatabaseHelper alloc]init];
    }

...
static BabyKeyboardHelper *sharedBabyKeyboardHelper = nil;

@implementation BabyKeyboardHelper

+(BabyKeyboardHelper *)sharedInstance{
    if (!sharedBabyKeyboardHelper) {
        sharedBabyKeyboardHelper = [[BabyKeyboardHelper alloc]init];
    }
    return sharedBabyKeyboardHelper;
}

...
/**
 --------------------------------------------------------------
 `BabyShowHelper`基于`MBProgressHUD`封装的提示管理类,MBManager
 --------------------------------------------------------------
 */
@interface BabyShowHelper : NSObject
...
/**
 *  显示“加载中”，带圈圈，若要修改直接修改BabyLoadingMessage的值即可
 */
+ (void)showLoading;
/**
...
/**
 *  显示简短的提示语，默认2秒钟，时间可直接修改BabyshowTime
 *
 *  @param alert 提示信息
 */
